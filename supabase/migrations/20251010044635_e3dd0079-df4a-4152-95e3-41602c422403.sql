...
DECLARE
  v_token TEXT;
BEGIN
  -- Generate a unique token based on idea_id, user_id, and timestamp
  v_token := encode(
    digest(
...
-- Create function to verify ledger integrity
...
DECLARE
  v_end_block BIGINT;
BEGIN
  -- If end_block is null, use the latest block
...
-- RLS Policies for idea_ownership
...
-- RLS Policies for ownership_challenges
